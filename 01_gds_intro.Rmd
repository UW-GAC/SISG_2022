...
Set a filter selecting only multi-allelic variants. Inspect their genotypes using the different methods you learned above. Use the `alleleDosage` method to find dosage for the second (and third, etc.) alternate allele.
...
### Solution 1.2 (Application)

Use the `VCF to GDS Converter` app to convert the example 1000 Genomes files into GDS files.
