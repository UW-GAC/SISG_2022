...
The output of this analysis will be a single `_pruned.gds` file with the genotype data from the LD pruned variants across all 22 chromosomes.
...
The output of this analysis will be a `_king_robust.gds` file that has the kinship estimates and a `_king_robust_all.pdf` with the plot of estimated kinship vs. IBS0. Look at the kinship plot -- how many 1st degree relative pairs are identified? How many 2nd degree relative pairs are identified?
...
The output of this analysis is a `_pcrelate.RData` file that contains the PC-Relate relatedness estimates, a `_pcrelate_Matrix.RData` file that contains a sparse matrix of kinship estimates (more on this in the Mixed Model tutorial), and a `_pcrelate_all.pdf` with the plot of estimated kinship vs. k0. Look at the kinship plot -- how many 1st degree relative pairs are identified? How many 2nd degree relative pairs are identified?
